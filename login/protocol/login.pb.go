...
type LoginResponse struct {
	...
	HttpCode uint64 `protobuf:"varint,3,opt,name=HttpCode,proto3" json:"HttpCode,omitempty"`
}
...
func (x *LoginResponse) GetHttpCode() uint64 {
	if x != nil {
		return x.HttpCode
	}
	return 0
...
var file_login_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0x5c, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x45, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x5d, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65,
	...
	0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x48, 0x74, 0x74, 0x70,
	0x43, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x48, 0x74, 0x74, 0x70,
	0x43, 0x6f, 0x64, 0x65, 0x32, 0x4f, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x3f, 0x0a, 0x0a, 0x52, 0x65, 0x61, 0x64, 0x79, 0x4c, 0x6f, 0x67,
	0x69, 0x6e, 0x12, 0x16, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x4c, 0x6f,
	0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_login_proto_depIdxs = []int32{
	0, // 0: protocol.LoginService.ReadyLogin:input_type -> protocol.LoginRequest
	1, // 1: protocol.LoginService.ReadyLogin:output_type -> protocol.LoginResponse
...
type LoginServiceClient interface {
	// 准备登陆
	ReadyLogin(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
}
...
func (c *loginServiceClient) ReadyLogin(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, "/protocol.LoginService/ReadyLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LoginServiceServer interface {
	// 准备登陆
	ReadyLogin(context.Context, *LoginRequest) (*LoginResponse, error)
}
...
func (*UnimplementedLoginServiceServer) ReadyLogin(context.Context, *LoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadyLogin not implemented")
}
...
func _LoginService_ReadyLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoginServiceServer).ReadyLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protocol.LoginService/ReadyLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).ReadyLogin(ctx, req.(*LoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _LoginService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "protocol.LoginService",
	HandlerType: (*LoginServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ReadyLogin",
			Handler:    _LoginService_ReadyLogin_Handler,
		},
	},
