...
var file_register_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x2a, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xa4, 0x01,
	0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x47, 0x0a, 0x0c, 0x49, 0x73, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65,
	0x64, 0x12, 0x1b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x69, 0x73, 0x52,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x0d, 0x52, 0x65,
	0x61, 0x64, 0x79, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x1b, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x69, 0x73, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x63, 0x6f, 0x6c, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
...
var file_register_proto_depIdxs = []int32{
	...
	0, // 1: protocol.RegisterService.ReadyRegister:input_type -> protocol.isRegisterRequest
	2, // 2: protocol.RegisterService.IsRegistered:output_type -> protocol.RegisterResponse
	2, // 3: protocol.RegisterService.ReadyRegister:output_type -> protocol.RegisterResponse
...
type RegisterServiceClient interface {
	...
	// 准备注册
	ReadyRegister(ctx context.Context, in *IsRegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error)
}
...
func (c *registerServiceClient) ReadyRegister(ctx context.Context, in *IsRegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	out := new(RegisterResponse)
...
type RegisterServiceServer interface {
	...
	// 准备注册
	ReadyRegister(context.Context, *IsRegisterRequest) (*RegisterResponse, error)
}
...
func (*UnimplementedRegisterServiceServer) ReadyRegister(context.Context, *IsRegisterRequest) (*RegisterResponse, error) {
...
func _RegisterService_ReadyRegister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegisterServiceServer).ReadyRegister(ctx, req.(*IsRegisterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
